...
function Hide()
{
    ...
    document.getElementById("Dswitch").style.marginLeft="0.7rem"
}
...
const Projects=()=>{
    return (
        <section id="project">
            ...
            <a href="https://github.com/mrrajeev29" target="_blank"><button type="button" className="Abtn">&emsp;<i class="fa fa-github"></i>&ensp;All&ensp;</button></a>      
        </section>
    )
}
